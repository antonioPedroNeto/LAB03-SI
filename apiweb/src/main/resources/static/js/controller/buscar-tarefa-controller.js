appLab.controller("buscarTarefaController", function ($scope, $http, $routeParams) {
    ...
    $scope.buscarSubTarefa = function () {
        ...
        $http({
            method:'GET',
            url:'/buscarSubTarefa/'+$routeParams.nomeSubTarefa
    ...
    $scope.editarNomeSubTarefa = function () {
        ...
        $http({
            method:'POST',
            url:'http://localhost:8080/editarNomeSubTarefa/'+$scope.subTarefaEditada.nome+'/'+$scope.subTarefaEditada.nomeTarefa+'/'+$scope.subTarefa.nome
    ...
    $scope.trocarPrioridadeSubTarefa = function () {
        ...
        $http({
            method:'POST',
            url:'http://localhost:8080/trocarPrioridadeSubTarefa/'+$scope.subTarefaEditada.nome+'/'+$scope.subTarefaEditada.nomeTarefa+'/'+$scope.subTarefa.prioridade
    ...
    $scope.editarDescricaoSubTarefa = function () {
        ...
        $http({
            method:'POST',
            url:'http://localhost:8080/editarDescricaoSubTarefa/'+$scope.subTarefaEditada.nome+'/'+$scope.subTarefaEditada.nomeTarefa+'/'+$scope.subTarefa.descricao
    ...
    $scope.editarDataSubTarefa = function () {
        ...
        $http({
            method:'POST',
            url:'http://localhost:8080/editarDataSubTarefa/'+$scope.subTarefaEditada.nome+'/'+$scope.subTarefaEditada.nomeTarefa+'/'+$scope.subTarefa.data
    ...
    $scope.editarCategoriaSubTarefa = function () {
        ...
        $http({
            method:'POST',
            url:'http://localhost:8080/editarCategoriaSubTarefa/'+$scope.subTarefaEditada.nome+'/'+$scope.subTarefaEditada.nomeTarefa+'/'+$scope.subTarefa.categoria
    ...
    $scope.removerSubTarefa = function () {
        ...
        $http({
            method:'POST',
            url:'http://localhost:8080/removeSubTarefa/'+$scope.subTarefa.nome+'/'+$scope.subTarefa.nomeTarefa
